...
const Antarctica = () => {
  return (
    <>
      <Head>
        <title>Evin Sellin - Antarctica</title>
      </Head>
      <div className={styles.container}>
        <main className={styles.main}>
          ...
          <p>
            ...
            I'm advertising exclusively to Antarctica in the hopes that the
            right person sees this. Are you the right person?
          </p>
          <h2>I'm good at computers.</h2>
          <p>
            I have a strong resume in a mostly unrelated technical field
            (Machine Learning Infrastructure). I've worked at <b>Google</b>,{" "}
            <b>Discord</b>, and a few other shops. I assume y'all aren't trying
            to train ML models down south, which makes it difficult to slot into
            standard IT roles and am likely filtered out by the system. Despite
            this, I've got a strong background in computing, am used to learning
            on the fly, and have the technical know-how to handle unexpected and
          ...
          <p>
            ...
            and am an amateur blacksmith. I love to learn new things, and am
            eager to pick up any skills, trades, or crafts that are needed.
          </p>
          <h2>I will work for peanuts.</h2>
          <p>
            No job is too small for me. You want someone to manually copy cells
            between excel sheets for minimum wage? I'm your guy. You want
            someone to crimp a bajillion ethernet cables for 12 hours a day over
            the austral winter? Let me at it. I WANT to be there. I WANT to
            contribute in the best way I can. Whatever that ends up being, I'm
            ready to do.
          </p>
          <h2>Thank you so much for your attention.</h2>
          <p>
            Let me know what I can do to get a job in Antarctica. Email me. Text
            me. Tweet at me. Send me snail mail if you have to. Thank you so
